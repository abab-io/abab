...
contract TestAbabRoom {
	function testUpsertRoom_InsertUpdateLogic() {		
		...
		Assert.equal( abab.UpsertRoom(3, 0xffffffffffffffffffff,0,0), 3, "insert full uint20");
